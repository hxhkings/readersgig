...
<div class="row">
	<div class="col-md-4 col-md-offset-4">
		<h1 class="text-center title">Home Page</h1>
	</div>
</div>
<div class="row">
	
	<div  style="margin:20px 2%">
		<?php echo $this->Html->link('Published Articles', array('controller' => 'articles', 'action' => 'lists'), array('class' => 'btn btn-success col-md-4')); ?>
		</div>
	<?php if ($check && ($userRole == 3)): ?>
		<div  style="margin:20px 2%">
		<?php echo $this->Html->link('Create Article', array('controller' => 'articles', 'action' => 'create'), array('class' => 'btn btn-success col-md-4')); ?>
		</div>
	<?php endif; ?>
	<?php if ($check && ($userRole == 3 || $userRole == 2)): ?>
	<div  style="margin:20px 2%">
		<?php echo $this->Html->link('Review Articles', array('controller' => 'articles', 'action' => 'review'), array('class' => 'btn btn-success col-md-4')); ?>
		</div>
	<?php endif; ?>
